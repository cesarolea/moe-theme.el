...
(let ((class '((class color) (min-colors 89)))
      ;; Palette colors.
      (yellow-1 "#f1fa8c") (yellow-2 "#d8e17e") (yellow-3 "#c0c870") (yellow-3-5 "#a8af62") (yellow-4 "#909654")
      (orange-1 "#ffb86c") (orange-2 "#e5a561") (orange-3 "#cc9356") (orange-4 "#b2804b") (orange-5 "#996e40")
      ...
      (blue-1 "#6272a4") (blue-2 "#586693") (blue-3 "#4e5b83") (blue-4 "#444f72") (blue-5 "#3a4462") (blue-6 "#313952")
      (purple-1 "#bd93f9") (purple-2 "#aa84e0") (purple-3 "#9775c7") (purple-4 "#8466ae")
      (red-1 "#ff5555")  (red-2 "#e54c4c")  (red-3 "#cc4444") (red-4 "#b23b3b")
      (white-1 "#f8f8f2") (white-2 "#dfdfd9") (white-3 "#c6c6c1")
      (black-1 "#a") (black-2 "#7e7f86") (black-2-5 "#686972") (black-3 "#52545e") (black-4 "#3d3f4a") (black-5 "#282a36") (black-6 "#000000")
      (LIGHT_BG "#fdfde7") (white-0 "#ffffff")
      (green-02 "#50fa7b") (green-01 "#48e16e") (green-0 "#40c862") (green-00 "#38af56")
      (cyan-0 "#8be9fd")
      ...
      (current-line-highlight "#3d3f4a") (region-foreground "#f8f8f2") (region-background "#44475a")
      (dracula-blue-1 "") (dracula-blue-2 "") (dracula-blue-3 "#6272a4")
      (dracula-orange "#ffb86c") (dracula-cyan "#8be9fd") (dracula-green "#50fa7b") (dracula-pink "#ff79c6") (dracula-purple "#bd93f9") (dracula-red "#ff5555") (dracula-yellow "#f1fa8c"))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:foreground ,region-foreground :background ,yellow-3))))
   `(secondary-selection ((,class (:background ,blue-3 :foreground ,white-0))))
   `(isearch ((,class (:foreground ,white-1 :background ,dracula-orange))))
   `(lazy-highlight ((,class (:background ,magenta-3 :foreground ,white-1))))
   `(trailing-whitespace ((,class (:background ,red-3))))
   `(show-paren-match ((,class (:background ,dracula-blue-3 :foreground nil))))
   ...
   `(minibuffer-prompt ((,class (:foreground ,black-3 :background ,dracula-green))))
   `(escape-glyph ((,class (:foreground ,yellow-3))))
   `(error ((,class (:foreground ,dracula-red))))
   `(warning ((,class (:foreground ,dracula-orange))))
   `(success ((,class (:foreground ,dracula-green))))

   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,dracula-purple))))
   ...
   `(magit-branch-local ((,class (:foreground ,green-4 :background nil :bold t :underline t))))
   `(magit-branch-remote ((,class (:foreground ,blue-0 :background nil :bold t :underline t))))
   ...
   `(magit-tag ((,class (:foreground ,blue-0 :background nil))))
