...
(defun moe-light ()
  ...
  (cond ((eq moe-theme-mode-line-color 'dracula)
         (set-face-attribute 'mode-line nil :background "#9775c7" :foreground "#313952")
         (set-face-attribute 'mode-line-buffer-id nil :background "#9775c7" :foreground "#282a36")
         (set-face-attribute 'minibuffer-prompt nil :foreground "#ff5555" :background "#3a3a3a"))
        ((eq moe-theme-mode-line-color 'blue)
...
as long as setq `moe-theme-mode-line-color' first."
    ...
    (cond ((eq (frame-parameter nil 'background-mode) 'light)
           (set-face-attribute 'mode-line-buffer-id nil :background nil :foreground "#1c1c1c")
             ...
             (cond ((eq moe-theme-mode-line-color 'dracula)
                    (set-face-attribute 'mode-line nil :background "#9775c7" :foreground "#f8f8f2")
                    (set-face-attribute 'powerline-active1 nil :background "#c3c9f8" :foreground "#313952"))
                   ((eq moe-theme-mode-line-color 'blue)
